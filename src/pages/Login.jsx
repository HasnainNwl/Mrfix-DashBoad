    ...
    return (
        <>
            <div className=" flex flex-wrap  text-gray-500 ">
                ...
                <div className="hidden lg:flex lg:w-3/5 pr-4 pl-4 xl:w-2/3 pr-4 pl-4 items-center">
                        ...
                        <form className="mb-3 " >
                            ...
                            <div className="mb-3 ">
                                ...
                                <div className="relative flex items-stretch w-full ">
                                    <input type="password" className="w-full py-1 px-2 mb-1   border border-gray-200 rounded " placeholder="············" />
                            ...
                            <button className=" text-center  border font-normal rounded py-1 px-3  bg-blue-600 text-white hover:bg-blue-600  w-full">Sign in</button>
